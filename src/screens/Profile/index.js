...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { icon: 'save', label: 'Настроить верификацию лица', type: 'link', navigate: 'FaceId' },
      { icon: 'download', label: 'Изменить пароль', type: 'link' },
      { icon: 'download', label: 'Добавить родителя', type: 'link', navigate: 'AddParent' },
    ],
  },
];
        ...
        <ScrollView>
            <View>
                <View className="items-center my-4">
                    ...
                    <TouchableOpacity
                        className="relative bg-[#3CAE8B] bg-cover py-4 px-8 rounded-xl mt-5" 
                    >
                        <Text className="color-white text-xl font-semibold">Редактировать профиль</Text>
                    </TouchableOpacity>
                </View>
                <View className="items-center ">
                    <View className="bg-white w-[90%] rounded-t-xl" >  
